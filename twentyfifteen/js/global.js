...
//                     //  else {
//                     // $('.FinderResult-post:eq('+i+')').insertAfter($('.FinderResult-post:eq('+i-1+')'))
//                     //  console.log("déplacer la région");


//                     // p = $('.region')[i - 1];
//                     // if ($('.city:eq(0)').parents('.FinderResult-post.row').attr("data-id") !== $('.region:eq(' + i + ')').parents('.FinderResult-post.row').attr("data-id")) {
//                     //   p = $('.region:eq(' + i + ')').parents('.FinderResult-post.row').nextAll('.FinderResult-post.row').find('.city').html().trim();
//                     //   a = $('.region:eq(' + i + ')').parents('.FinderResult-post.row').prev('.FinderResult-post.row').find('.city').html().trim();
//                     //   console.log(a);
//                     //   // a = $('.region')[i + 1];
//                     //   if ( a === p ) {
//                     //     alert(a + p);
...
//                     $r = $(this).find('.job').html().trim()
//                     $p = $(this).nextAll('.FinderResult-post.row').find('.job').html().trim();
//                     $a = $('.FinderResult-post:eq(' + (i - 1) + ')').find('.job').html().trim();
